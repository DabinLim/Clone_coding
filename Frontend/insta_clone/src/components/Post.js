  ...
  return (
    <React.Fragment>
      {user_name == props.name ? <Grid flex_column margin='0px'>
        <EditPost visible={modalVisible} onClose={closeModal} maskClosable={true} closable={true}/>
        <DetailContainer>
          <UserInfo>
            <Grid flex_row>
            ...
            >
              <Text cursor='pointer' _onClick={openModal}>수정</Text><Text cursor='pointer'_onClick={deletePost}>삭제</Text>
            </Grid>
          </UserInfo>
